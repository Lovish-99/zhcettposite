...
import {
  MDBBtn, MDBContainer, MDBRow, MDBCol, MDBCard, MDBCardBody, MDBRadio,
} from "mdb-react-ui-kit";
import { Link, useNavigate } from "react-router-dom";
import { Country, State, City } from "country-state-city";
import AddTempaddress from "./AddStudentTempAddress";

function AddStudentPerAddress() {
                ...
                <MDBRow>
                  ...
                  <MDBCol>
                    <label htmlFor="street">
                      Area, Street, Sector, Village <span style={{color: "red", fontSize:"20px"}}>*</span>:
                    </label>
                    <input
                      className="form-control"
                      type="text"
...
export default AddStudentPerAddress;
